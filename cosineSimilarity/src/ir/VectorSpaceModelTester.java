...
//		Document gray = new Document("50-shades.txt");
		Document d1 = new Document("academic_posts.txt");
		Document d2 = new Document("mental-health.txt");
		Document d3 = new Document("general-penn-subreddit.txt");
		Document d5 = new Document("general-reddit.txt");
